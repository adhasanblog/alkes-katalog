...
// Ambil dari WP query var, bukan $_GET.
$preserved = array();
...
// post_type: kalau halaman ini memang katalog produk, aman dipaksa "produk"
$preserved['post_type'] = 'produk';
?>

<div class="w-full mb-4">
	<div class="bg-white p-4 rounded-sm shadow-sm border border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
		...
		<div class="flex items-center gap-3 border-t md:border-t-0 border-slate-100 pt-4 md:pt-0">
			...
			<form method="get" action="<?php echo esc_url( $base_url ); ?>">
				...
				<div class="relative">
					<select
						id="sort"
						name="sort"
						class="appearance-none bg-slate-50 border border-slate-200 text-slate-700 text-sm font-medium py-2.5 pl-4 pr-10 rounded-sm
			...
			<a
				...
				class="px-4 py-2 bg-white text-slate-700 border border-slate-200 text-sm font-medium rounded-sm hover:bg-slate-50 transition-colors whitespace-nowrap"
			>
				Reset
			</a>
		</div>
